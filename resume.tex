...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Technologies}{: AWS, React, Django, PostgreSQL, Docker, Kubernetes, Tensorflow, Pandas, LINUX, Postman} \\
    }}
 \end{itemize}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Reviewed and presented knowledge from 3 deep learning research papers to the Principal Investigator and other PhD candidates}
...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{AirFleet} $|$ \emph{Python, Django, JavaScript, React, PostgreSQL, AWS, aviationstack API}}{July 2021 -- September 2022}
          \resumeItemListStart
            \resumeItem{Developed Pilot Logbook web app that allows users to login to accounts and add entries to their logbooks, including entries such as trip photos and route-waypoint storage}
