  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Revamped a \textbf{Spatial Neural Network} by integrating \textbf{long short-term memory} modules to analyze limit order books, growing simulated trade volumes by 13\%}
    \resumeItemListEnd
...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListEnd
      \resumeProjectHeading
          {\textbf{Stock Correlator} $|$ \emph{Python, BeautifulSoup4, SciKit-Learn, pandas, Yahoo! Stocks API}}{May 2020 -- June 2021}
          \resumeItemListStart
