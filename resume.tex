...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Designed, developed, and deployed \textbf{AWS Lambdas} used in CRUD operations for use in ETF trading systems}
        \resumeItem{Expedited data processing development for a project for \textbf{GDP Nowcasting}, resulting in a 3x more effective team}
      \resumeItemListEnd
...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{AirFleet} $|$ \emph{Django, React, PostgreSQL, AWS Lightsail, Auth0, aviationstack}}{July 2021 -- September 2022}
          \resumeItemListStart
          ...
          \resumeItemListEnd
      \resumeProjectHeading
          {\textbf{Stock Correlator} $|$ \emph{BeautifulSoup4, SciKit-Learn, pandas, Yahoo! Stocks API}}{May 2020 -- June 2021}
          \resumeItemListStart
