  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Programmed an \textbf{AWS Lambda} hosted Function-as-a-Service which uses \textbf{Python}'s \textbf{boto3} library to crawl through and delete data from Vanguard \textbf{AWS Glue} databases}
        ...
        \resumeItem{Queried Vanguard AWS Athena Databases with SQL for project stakeholders}
      \resumeItemListEnd
