...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Technologies}{: AWS, React, Django, PostgreSQL, Docker, Kubernetes, Tensorflow, Pandas, LINUX} \\
    }}
 \end{itemize}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Developed cloud infrastructure to connect to market data suppliers, resulting in savings of \textgreater \textbf{\$100,000} / month}
        \resumeItem{Programmed a \textbf{Lambda} hosted FaaS which uses \textbf{Python}'s \textbf{boto3} library to crawl through and delete data from \textbf{AWS Glue} databases}
    ...
    \resumeSubheading
      ...
      {The Vanguard Group}{Malvern, PA}
      \resumeItemListStart
        \resumeItem{Re-engineered Debt Service Coverage Ratio calculations in \textbf{TypeScript} to be more accurate and maintainable, improving bond trading performance by 5\%}
        ...
        \resumeItem{Created a \textbf{React} hook to retrieve data from an \textbf{S3 bucket} and parse it into an interface to increase processing speeds by 25\%}
    \resumeItemListEnd
    ...
    \resumeSubheading
        ...
        \resumeItemListStart
        \resumeItem{Ran technical operations and \textbf{helped over 350 staff and students} with technical problems}
        \resumeItem{Collaborated with staff to counter network outages and provide support when faculty and students were effected}
        \resumeItem{Set up WiFi wiring throughout ComArtSci building, giving \textbf{more than 3,500 people} secure access to the internet}
        \resumeItemListEnd
    \resumeSubHeadingListEnd
...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Developed Pilot Logbook web app that allows users to log-in and add entries to their logbooks, including entries such as trip photos and route-waypoint storage}
            \resumeItem{Created and connected a \textbf{PostgreSQL} database that stores all data, and is maintained on \textbf{AWS Lightsail}}
            \resumeItem{Implemented \textbf{RESTful architecture} with \textbf{Django} for entry, updating, and deletion of logbook data by users}
            \resumeItem{Connected Django to a \textbf{React} frontend to provide a smooth user experience}
          \resumeItemListEnd
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Algorithmically calculated R value of Adjusted Closes between 500 companies using \textbf{SciKit-Learn}}
